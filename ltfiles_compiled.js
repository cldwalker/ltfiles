...
goog.require('lt.objs.tabs');
lt.plugins.ltfiles.browse.tab_open_current_url = (function tab_open_current_url(){var current_word = lt.plugins.ltfiles.util.current_word.call(null);var pre_commands = (((cljs.core.count.call(null,new cljs.core.Keyword(null,"tabsets","tabsets",3756175576).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.tabs.multi))) < 2))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tabset.new","tabset.new",1444331601)], null):cljs.core.PersistentVector.EMPTY);var commands = cljs.core.into.call(null,pre_commands,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-browser-tab","add-browser-tab",3663273910),new cljs.core.Keyword(null,"tabs.move-next-tabset","tabs.move-next-tabset",3557293229),new cljs.core.Keyword(null,"browser.url-bar.focus","browser.url-bar.focus",3353788299),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"browser.url-bar.navigate!","browser.url-bar.navigate!",1014303491),current_word], null),new cljs.core.Keyword(null,"browser.focus-content","browser.focus-content",1148241840)], null));var seq__8790 = cljs.core.seq.call(null,commands);var chunk__8791 = null;var count__8792 = 0;var i__8793 = 0;while(true){
if((i__8793 < count__8792))
{var c = cljs.core._nth.call(null,chunk__8791,i__8793);if(cljs.core.coll_QMARK_.call(null,c))
...
{var temp__4092__auto__ = cljs.core.seq.call(null,seq__8790);if(temp__4092__auto__)
{var seq__8790__$1 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__8790__$1))
{var c__7497__auto__ = cljs.core.chunk_first.call(null,seq__8790__$1);{
var G__8798 = cljs.core.chunk_rest.call(null,seq__8790__$1);
var G__8799 = c__7497__auto__;
var G__8800 = cljs.core.count.call(null,c__7497__auto__);
var G__8801 = 0;
seq__8790 = G__8798;
chunk__8791 = G__8799;
count__8792 = G__8800;
...
{var c = cljs.core.first.call(null,seq__8790__$1);if(cljs.core.coll_QMARK_.call(null,c))
{cljs.core.apply.call(null,lt.objs.command.exec_BANG_,c);
} else
{lt.objs.command.exec_BANG_.call(null,c);
}
...
lt.plugins.ltfiles.browse.sh = (function sh(cmd){return require("child_process").exec.call(null,cmd,(function (err,stdout,stderr){if(cljs.core.seq.call(null,stdout))
...
lt.plugins.ltfiles.browse.system_open_current_url = (function system_open_current_url(){return lt.plugins.ltfiles.browse.sh.call(null,[cljs.core.str("open "),cljs.core.str(lt.plugins.ltfiles.util.current_word.call(null))].join(''));
});
...
return (function (p1__9006_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword("lt.objs.editor","hide-line-numbers","lt.objs.editor/hide-line-numbers",1337733131),p1__9006_SHARP_);
});})(ws_behavior))
...
return (function (p1__9007_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword("lt.objs.editor.file","remove-trailing-whitespace","lt.objs.editor.file/remove-trailing-whitespace",1399383588),p1__9007_SHARP_);
});})(ws_behavior))
...
return (function (p1__9008_SHARP_){return cljs.core.cons.call(null,new cljs.core.Keyword("lt.objs.editor.file","remove-trailing-whitespace","lt.objs.editor.file/remove-trailing-whitespace",1399383588),p1__9008_SHARP_);
...
lt.plugins.ltfiles.refresh_current_folder = (function refresh_current_folder(){var temp__4090__auto__ = cljs.core.some.call(null,(function (p1__9017_SHARP_){if(cljs.core.truth_(lt.plugins.ltfiles.util.parent_QMARK_.call(null,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,p1__9017_SHARP_)),lt.plugins.ltfiles.util.current_file.call(null))))
