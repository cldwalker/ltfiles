...
return (function (p1__8601_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword("lt.objs.editor","hide-line-numbers","lt.objs.editor/hide-line-numbers",1337733131),p1__8601_SHARP_);
});})(ws_behavior))
...
return (function (p1__8602_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword("lt.objs.editor.file","remove-trailing-whitespace","lt.objs.editor.file/remove-trailing-whitespace",1399383588),p1__8602_SHARP_);
});})(ws_behavior))
...
return (function (p1__8603_SHARP_){return cljs.core.cons.call(null,new cljs.core.Keyword("lt.objs.editor.file","remove-trailing-whitespace","lt.objs.editor.file/remove-trailing-whitespace",1399383588),p1__8603_SHARP_);
...
lt.plugins.ltfiles.open_current_url = (function open_current_url(){var current_word = lt.plugins.ltfiles.util.current_word.call(null);var pre_commands = (((cljs.core.count.call(null,new cljs.core.Keyword(null,"tabsets","tabsets",3756175576).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.tabs.multi))) < 2))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tabset.new","tabset.new",1444331601)], null):cljs.core.PersistentVector.EMPTY);var commands = cljs.core.into.call(null,pre_commands,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-browser-tab","add-browser-tab",3663273910),new cljs.core.Keyword(null,"tabs.move-next-tabset","tabs.move-next-tabset",3557293229),new cljs.core.Keyword(null,"browser.url-bar.focus","browser.url-bar.focus",3353788299),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"browser.url-bar.navigate!","browser.url-bar.navigate!",1014303491),current_word], null),new cljs.core.Keyword(null,"browser.focus-content","browser.focus-content",1148241840)], null));var seq__8616 = cljs.core.seq.call(null,commands);var chunk__8617 = null;var count__8618 = 0;var i__8619 = 0;while(true){
if((i__8619 < count__8618))
{var c = cljs.core._nth.call(null,chunk__8617,i__8619);if(cljs.core.coll_QMARK_.call(null,c))
{cljs.core.apply.call(null,lt.objs.command.exec_BANG_,c);
} else
{lt.objs.command.exec_BANG_.call(null,c);
}
{
var G__8620 = seq__8616;
var G__8621 = chunk__8617;
var G__8622 = count__8618;
var G__8623 = (i__8619 + 1);
seq__8616 = G__8620;
chunk__8617 = G__8621;
count__8618 = G__8622;
i__8619 = G__8623;
...
{var temp__4092__auto__ = cljs.core.seq.call(null,seq__8616);if(temp__4092__auto__)
{var seq__8616__$1 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__8616__$1))
{var c__7497__auto__ = cljs.core.chunk_first.call(null,seq__8616__$1);{
var G__8624 = cljs.core.chunk_rest.call(null,seq__8616__$1);
var G__8625 = c__7497__auto__;
var G__8626 = cljs.core.count.call(null,c__7497__auto__);
var G__8627 = 0;
seq__8616 = G__8624;
chunk__8617 = G__8625;
count__8618 = G__8626;
...
{var c = cljs.core.first.call(null,seq__8616__$1);if(cljs.core.coll_QMARK_.call(null,c))
{cljs.core.apply.call(null,lt.objs.command.exec_BANG_,c);
} else
{lt.objs.command.exec_BANG_.call(null,c);
}
{
var G__8628 = cljs.core.next.call(null,seq__8616__$1);
var G__8629 = null;
var G__8630 = 0;
var G__8631 = 0;
seq__8616 = G__8628;
...
lt.objs.command.command.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"ltfiles.open-current-url","ltfiles.open-current-url",3442269609),new cljs.core.Keyword(null,"desc","desc",1016984067),"ltfiles: opens url under cursor in another tabset and browser",new cljs.core.Keyword(null,"exec","exec",1017031683),lt.plugins.ltfiles.open_current_url], null));
}
